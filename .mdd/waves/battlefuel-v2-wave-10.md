...
| 5 | waypoint-routing | docs/64-waypoint-routing.md | complete | routing-mode-multi-route-ui |
| 6 | hand-drawn-passage-obstacle-depot-editing | docs/65-hand-drawn-passage-obstacle-depot-editing.md | complete | routing-mode-multi-route-ui |

> **F6 descope (requester, 2026-06-04):** delivered add-fuel-depot (full-stack) + remove-manual-obstacle
> (already shipped in Wave 4). **Hand-drawn passage was descoped** — it injects routable edges into
> the pgRouting `ways` graph and is better as a future routing-data wave (needs the live graph).
> Logged in TODO.md.
