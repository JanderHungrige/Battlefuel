...
Both features built, committed, full suite green; all deploy gates passed:
- [x] **tested local** — `make dev` localhost demo verified
- [x] **tested online** — `dev-deployment` → `:3001`, road + off-road verified
- [x] **merged into main / deployed in prod** — `:3000`, road + off-road verified
