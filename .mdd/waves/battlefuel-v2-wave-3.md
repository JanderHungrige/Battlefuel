...
|---|---------|-----|--------|------------|
| 1 | located-event-model        | docs/49-located-event-model.md | complete | — |
| 2 | threat-mgrs-squares        | docs/50-threat-mgrs-squares.md | complete | located-event-model |
| 3 | event-hover-icons          | docs/51-event-hover-icons.md | complete | threat-mgrs-squares |
| 4 | chatter-mgrs-tagging       | docs/52-chatter-mgrs-tagging.md | complete | located-event-model |
| 5 | enemy-red-nato-units       | docs/53-enemy-red-nato-units.md | complete | — |
| 6 | depot-nato-symbol-fuelbars | docs/54-depot-nato-symbol-fuelbars.md | complete | — |
