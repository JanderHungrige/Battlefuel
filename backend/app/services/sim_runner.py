...
from app.providers.combat_event_catalog import build_combat_event_catalog_provider
...
class SimEngine:
    ...
    async def _run(self) -> None:
        ...
        events = EventEngine(
            Random(),
            catalog=build_combat_event_catalog_provider(settings).items(),
            mean_interval_game_s=settings.event_mean_interval_game_s,
            enabled=settings.game_mode,
            revert_game_s=settings.event_revert_game_s,
