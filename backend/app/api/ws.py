...
async def ws_endpoint(ws: WebSocket) -> None:
    # The threat laydown is the tiles' own state (fetched via GET /tiles, incl. last_event), so no
    # on-connect snapshot is needed; live changes arrive as tile_update / enemy_unit frames.
